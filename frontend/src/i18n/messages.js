    ...
    dashboard: {
      ...
      admin: {
        ...
        overview: {
          ...
          selectedSeasonCard: 'Selected season',
          seasonMatchesCard: 'Season matches',
    ...
    dashboard: {
      ...
      admin: {
        ...
        status: {
          ...
          startsInDays: 'Empieza en {days} días',
          endedDaysAgo: 'Terminó hace {days} días',
        ...
        overview: {
          ...
          selectedSeasonCard: 'Temporada seleccionada',
          seasonMatchesCard: 'Partidos de temporada',
