export const messages = {
  en: {
    ...
    claim: {
      ...
      linkExistingAction: 'Sign in and link',
      noAccountQuestion: "Don't have an account?",
      createNewAction: 'Create a new one',
    ...
    dashboard: {
      ...
      admin: {
        ...
        status: {
          ...
          missing: 'Missing',
          sameAsActive: 'Matches the active season',
          differentFromActive: 'Different from the active season',
          matchesOpenClosed: '{open} open · {closed} closed',
          registeredInSelected: 'Registered in the selected season',
        },
        table: {
          player: 'Player',
          guid: 'GUID',
        ...
        overview: {
          ...
          nextMatchPlace: 'To be confirmed',
          rosterHome: 'Home',
          rosterAway: 'Away',
          // stat carousel
          ...
          recentMatchesTitle: 'Recent Matches History',
        ...
        accountability: {
          title: 'Accountability & Funds',
          description: 'Track every movement, member dues, and pena transparency.',
          transparencyButton: 'Transparency',
          cashflowButton: 'Cash flow',
          // KPI cards
          kpiBalance: 'Total balance',
          kpiBalanceTrend: '{pct} vs last month',
          kpiFees: 'Membership fees',
          kpiFeesCollected: '{pct}% collected',
          kpiExpenses: 'Total expenses',
          kpiExpensesMonth: '{count} this month',
          kpiDues: 'Outstanding dues',
          kpiDuesPending: '{count} members pending',
          // New transaction form
          newTransaction: 'New transaction',
          income: 'Income',
          expense: 'Expense',
          amount: 'Amount',
          entity: 'Payer / recipient',
          entityPlaceholder: 'e.g. Sergio Ramos',
          concept: 'Concept',
          conceptPlaceholder: 'Describe the transaction…',
          category: 'Category',
          categoryPresets:
            'Membership,Donation,Sponsorship,Bar revenue,Equipment,Referee,Venue,Food & drink,Travel,Fees,Fines,Other',
          linkMember: 'Link member (optional)',
          linkMemberHelp: 'Recording income for a member pays down their dues.',
          date: 'Date',
          recordTransaction: 'Record transaction',
          // Ledger
          ledgerTitle: 'Transaction ledger',
          ledgerDescription: 'Detailed history of all movements.',
          filterAll: 'All',
          ...
          colAmount: 'Amount',
          colActions: 'Actions',
          ledgerCount: 'Showing {shown} of {total} transactions',
          previous: 'Previous',
          next: 'Next',
          // Members
          membersTitle: 'Member accounts',
          membersDescription: 'Track what each member owes and has paid. Toggle a row to edit it.',
          member: 'Member',
          debt: 'Debt',
          paid: 'Paid',
          net: 'Net',
          editRow: 'Edit',
          addMember: 'Add',
          noMembers: 'No member accounts yet.',
          save: 'Save',
          delete: 'Delete',
          cancel: 'Cancel',
          confirmDeleteTitle: 'Confirm deletion',
          confirmDeleteTransaction:
            'Delete the transaction “{concept}”? This updates the balance and cannot be undone.',
          confirmDeleteMember:
            'Delete this member account? Their dues and payments will be removed.',
          // Debtors breakdown (behind the dues KPI)
          debtorsTitle: 'Outstanding dues',
          debtorsDescription: 'Members with pending payments, most in debt first.',
          debtorsTotal: 'Total',
          noDebtors: 'Everyone is up to date.',
          // Transparency dialog
          transparencyTitle: 'Transparency settings',
          ...
          cashflowDescription: 'Monthly income vs expenses across the ledger.',
          openingBalance: 'Opening balance',
          reserveFund: 'Reserve fund',
          notices: {
            saved: 'Transparency settings updated',
        ...
        directory: {
          ...
          sortStatusActive: 'Active first',
          sortStatusInactive: 'Inactive first',
        ...
        matches: {
          ...
          editorTabStats: 'Stats & report',
          manualEventShow: 'Add manual event',
          manualEventHide: 'Hide manual event form',
        ...
        standings: {
          ...
          pairingViewGraph: 'Graph',
          pairingViewList: 'List',
          pairingViewTrios: 'Trios',
          pairingMinMatches: 'Min. matches: {count}',
          pairingNoneForFilter: 'No pairs match this filter.',
          insightsDateFrom: 'From',
          insightsDateTo: 'To',
          insightsClearDates: 'Clear dates',
    ...
    dashboard: {
      ...
      admin: {
        ...
        status: {
          ...
          sameAsActive: 'Coincide con la activa',
          differentFromActive: 'Distinta de la activa',
          matchesOpenClosed: '{open} abiertos · {closed} cerrados',
          registeredInSelected: 'Registrados en la temporada seleccionada',
        },
        table: {
          player: 'Jugador',
          guid: 'GUID',
        ...
        overview: {
          ...
          inviteCopy: 'Copiar código',
          inviteCopied: 'Copiado',
          inviteClose: 'Cerrar',
          matchRoster: 'Convocatoria',
          nextMatchPlace: 'Por confirmar',
          rosterHome: 'Local',
          rosterAway: 'Visitante',
          ...
          statPlayerStats: 'Stats de jugador',
          statWinRate: '% de victorias',
          statTotal: 'Total',
        ...
        accountability: {
          title: 'Contabilidad y Fondos',
          description: 'Controla cada movimiento, las cuotas de socios y la transparencia.',
          transparencyButton: 'Transparencia',
          cashflowButton: 'Flujo de caja',
          // Tarjetas KPI
          kpiBalance: 'Balance total',
          kpiBalanceTrend: '{pct} vs mes anterior',
          kpiFees: 'Cuotas de socios',
          kpiFeesCollected: '{pct}% cobrado',
          kpiExpenses: 'Gastos totales',
          kpiExpensesMonth: '{count} este mes',
          kpiDues: 'Deuda pendiente',
          kpiDuesPending: '{count} socios pendientes',
          // Formulario de nuevo movimiento
          newTransaction: 'Nuevo movimiento',
          income: 'Ingreso',
          expense: 'Gasto',
          amount: 'Importe',
          entity: 'Pagador / receptor',
          entityPlaceholder: 'p. ej. Sergio Ramos',
          concept: 'Concepto',
          conceptPlaceholder: 'Describe el movimiento…',
          category: 'Categoría',
          categoryPresets:
            'Cuota,Donación,Patrocinio,Barra,Material,Arbitraje,Instalación,Comida y bebida,Desplazamiento,Cuotas,Multas,Otros',
          linkMember: 'Vincular socio (opcional)',
          linkMemberHelp: 'Registrar un ingreso de un socio reduce su deuda.',
          date: 'Fecha',
          recordTransaction: 'Registrar movimiento',
          // Libro de movimientos
          ledgerTitle: 'Libro de movimientos',
          ledgerDescription: 'Historial detallado de todos los movimientos.',
          filterAll: 'Todos',
          ...
          colAmount: 'Importe',
          colActions: 'Acciones',
          ledgerCount: 'Mostrando {shown} de {total} movimientos',
          previous: 'Anterior',
          next: 'Siguiente',
          // Socios
          membersTitle: 'Cuentas de socios',
          membersDescription:
            'Controla lo que debe y ha pagado cada socio. Activa una fila para editarla.',
          member: 'Miembro',
          debt: 'Deuda',
          paid: 'Pagado',
          net: 'Neto',
          editRow: 'Editar',
          addMember: 'Añadir',
          noMembers: 'Aún no hay cuentas de miembros.',
          save: 'Guardar',
          delete: 'Eliminar',
          cancel: 'Cancelar',
          confirmDeleteTitle: 'Confirmar eliminación',
          confirmDeleteTransaction:
            '¿Eliminar el movimiento «{concept}»? Actualiza el balance y no se puede deshacer.',
          confirmDeleteMember: '¿Eliminar esta cuenta de socio? Se borrarán su deuda y sus pagos.',
          // Desglose de morosos (detrás del KPI de deuda)
          debtorsTitle: 'Deuda pendiente',
          debtorsDescription: 'Socios con pagos pendientes, de mayor a menor deuda.',
          debtorsTotal: 'Total',
          noDebtors: 'Todos al día.',
          // Diálogo de transparencia
          transparencyTitle: 'Configuración de transparencia',
          transparencyDescription:
          ...
          // Diálogo de flujo de caja
          cashflowTitle: 'Flujo de caja',
          cashflowDescription: 'Ingresos vs gastos por mes en el libro de movimientos.',
          openingBalance: 'Balance inicial',
          reserveFund: 'Fondo de reserva',
          notices: {
            saved: 'Configuración de transparencia actualizada',
            transactionAdded: 'Movimiento registrado',
        ...
        members: {
          ...
          seasonColumn: 'Temporada',
          inSeason: 'En la temporada',
          notInSeason: 'Fuera de la temporada',
          addToSeason: 'Añadir a temporada',
        ...
        directory: {
          ...
          sortStatusActive: 'Activos primero',
          sortStatusInactive: 'Inactivos primero',
        ...
        matches: {
          ...
          editorTabStats: 'Estadísticas y acta',
          manualEventShow: 'Añadir evento manual',
          manualEventHide: 'Ocultar formulario de evento manual',
        ...
        standings: {
          ...
          pairingViewGraph: 'Grafo',
          pairingViewList: 'Lista',
          pairingViewTrios: 'Tríos',
          pairingMinMatches: 'Mín. partidos: {count}',
          pairingNoneForFilter: 'Ninguna pareja cumple este filtro.',
          insightsDateFrom: 'Desde',
          insightsDateTo: 'Hasta',
          insightsClearDates: 'Limpiar fechas',
